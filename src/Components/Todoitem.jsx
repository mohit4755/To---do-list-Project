...
//   return (
//     <li className="flex items-center justify-between p-4 mb-4 bg-gradient-to-t from-[#FFDEE9] to-[#B5FFFC]  rounded-lg shadow-md mx-10 ">
//       {isEditing ? (
//         <>
//           <textarea
...
//           />
//           <button
//             className="ml-3 px-4 py-2 text-sm font-medium text-black bg-[#FFDEE9]  rounded-md hover:bg-yellow-400"
//             onClick={handleEdit}
//           >
//             Save
//           </button>
...
//           </div>
//           <button
//             className="ml-3 px-4 py-2 text-sm font-medium text-black bg-yellow-200 rounded-md hover:bg-yellow-300"
//             onClick={() => setIsEditing(true)}
//           >
//             Edit
//           </button>
//           <button
//             className="ml-3 px-4 py-2 text-sm font-medium text-black bg-yellow-200 rounded-md hover:bg-red-700"
